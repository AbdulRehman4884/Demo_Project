...
// OVERVIEW
const IndexPage = lazy(() => import('src/pages/dashboard/dashboard-index-redirect'));
...
export const dashboardRoutes = [
  {
    path: 'dashboard',
    element: (
      // Auth disabled for local frontend-only runs (restore <AuthGuard> when wiring a real API).
      <DashboardLayout>
